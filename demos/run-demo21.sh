...
if echo "$UART" | grep -q "D21OK"; then echo "  [PASS] UART: D21OK"; else echo "  [FAIL] UART: '$UART'"; PASS=false; fi
echo ""
if [ "$PASS" = true ]; then echo "Demo 21 PASSED"; else echo "Demo 21 FAILED"; exit 1; fi
