...
if echo "$UART" | grep -q "D19OK"; then echo "  [PASS] UART: D19OK"; else echo "  [FAIL] UART: '$UART'"; PASS=false; fi
echo ""
if [ "$PASS" = true ]; then echo "Demo 19 PASSED"; else echo "Demo 19 FAILED"; exit 1; fi
