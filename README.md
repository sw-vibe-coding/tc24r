...
tc24r is **functional** -- it compiles real C programs to COR24 assembly that runs on hardware and the cor24-rs emulator. 14 components, ~50 crates, 47 demos all passing. See [docs/status.md](docs/status.md) for detailed status and test counts.
...
|-----------|------|-------|-------|
| tc24r demos | 47 | 47 | End-to-end compiler + emulator |
